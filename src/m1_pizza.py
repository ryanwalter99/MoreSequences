...
def run_test_polygon():
    ...
    circle = rg.Circle(rg.Point(300,150), 115)
    circle.outline_thickness = 2
    polygon(window, circle, 9, 'blue', 3)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    title = 'Test 4'
    window = rg.RoseWindow(480, 480, title)

    circle = rg.Circle(rg.Point(300, 50), 150)
    circle.fill_color = 'green'
    fancy_polygon(window, circle, 15, 5, 'blue', 5)
    window.close_on_mouse_click()
